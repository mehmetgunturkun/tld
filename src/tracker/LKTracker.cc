...
vector<Box*> LKTracker::track(Frame* prev, Frame* curr, vector<Box*> boxList) {
    // filter stable boxes
...
vector<Box*> LKTracker::getStableBoxes(int nrOfBoxes, vector<Box*> boxList) {
...
vector<CvPoint2D32f*> LKTracker::decomposePoints(int nrOfBoxes, vector<Box*> boxList) {
...
float LKTracker::computeStep(float start, float end, int pointCount) {
...
vector<FBPoint*> LKTracker::track(Frame* prev, Frame* curr, int nrOfPoints, vector<CvPoint2D32f*> points) {
...
Option<Box*> LKTracker::estimate(Frame* prev, Frame* curr, Box* box, vector<FBPoint*> trackedPoints, int start, int end) {
...
vector<Box*> LKTracker::fragmentAndEstimateBoxList(Frame* prev,
                                                 Frame* curr,
                                                 int nrOfStableBoxes,
                                                 vector<Box*> stableBoxList,
                                                 int nrOfBoxes,
